...
RunService.RenderStepped:Connect(function()
    ...
    for player, objects in pairs(ESPObjects.Box2D) do
        ...
        -- FIXED: Using "esp_box" flag and "name_type" for box type
    ...
    for player, health in pairs(ESPObjects.Health) do
        ...
        -- FIXED: Using "esp_healthbar" flag
    ...
    for player, armor in pairs(ESPObjects.Armor) do
        ...
        -- FIXED: Using "esp_armor" and "esp_armored_only" flags
    ...
    for player, tracer in pairs(ESPObjects.Tracer) do
        ...
        -- FIXED: Using "esp_tracer_lines" flag
        if flags.esp_tracer_lines then
